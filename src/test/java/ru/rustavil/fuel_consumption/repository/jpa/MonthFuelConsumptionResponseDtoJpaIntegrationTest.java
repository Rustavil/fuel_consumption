...
public class MonthFuelConsumptionResponseDtoJpaIntegrationTest {
    ...
    public void whenInvokeCalculateFuelConsumptionByMonthThenExpected() {
        ...
        assertThat(found).contains(
                new MonthFuelConsumptionDto(2019, 6, FuelType.TYPE_98, 201.0, BigDecimal.valueOf(400000, 2),2000.0),
                new MonthFuelConsumptionDto(2019, 6, FuelType.TYPE_95, 501.5, BigDecimal.valueOf(800000, 2), 2666.6666666666665),
                new MonthFuelConsumptionDto(2019, 7, FuelType.TYPE_D, 501.5, BigDecimal.valueOf(800000, 2), 2666.6666666666665)
        );
    }
    ...
    public void whenInvokeCalculateFuelConsumptionByMonthAndDriverIdentifierThenExpected() {
        ...
        assertThat(found).contains(
                new MonthFuelConsumptionDto(2019, 6, FuelType.TYPE_98, 100.5, BigDecimal.valueOf(200000, 2), 2000.0),
                new MonthFuelConsumptionDto(2019, 6, FuelType.TYPE_95, 401.0, BigDecimal.valueOf(600000, 2), 3000.0),
                new MonthFuelConsumptionDto(2019, 7, FuelType.TYPE_D, 100.5, BigDecimal.valueOf(200000, 2), 2000.0)
        );
    }
